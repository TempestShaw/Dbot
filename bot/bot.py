...
async def daily_pipeline():
    ...
    premarket = get_stock_basic_change(URL)
...
@bot.command(name='triple',
             help='Returns the current price and percent change of the three major index (NASDAQ, DJI, and S&P 500).')
...
@bot.command(name="forecast",
             help="Returns the forecast prices of the next 5 days, from top to bottom, for a given stock symbol.")
