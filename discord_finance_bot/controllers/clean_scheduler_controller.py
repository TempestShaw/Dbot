"""
Clean Scheduler Controller - Only handles scheduling logic.
...
class CleanSchedulerController:
    """Clean scheduler controller that only handles scheduling."""
    ...
    def start(self) -> None:
        ...
        self.logger.info("Starting clean scheduler...")
