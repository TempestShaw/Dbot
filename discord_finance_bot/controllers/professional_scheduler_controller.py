"""
Professional Scheduler Controller with clean, structured display.

Removes all emojis and separates data sources for clarity.
Data sources:
- Polymarket: Earnings predictions with dates
- Alpha Vantage: Official earnings calendar
- Moomoo: Market sectors
"""
...
class ProfessionalSchedulerController:
    """Professional scheduler controller with structured data presentation."""
    ...
    def start(self) -> None:
        ...
        self.logger.info("Starting professional scheduler...")
    ...
    async def _send_to_channel(self, embed: discord.Embed) -> None:
        """Send embed to the configured channel asynchronously."""
    ...
    async def daily_update(self) -> None:
        ...
        embed = self._build_professional_embed(json_data)
        await self._send_to_channel(embed)
